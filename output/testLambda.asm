        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -loadArray-4-exit         
        Jump         -loadArray-4-loop         
        Label        -loadArray-4-exit         
        PushD        $a-array-length-temp      
        LoadI                                  
        ...
        PushD        $print-format-character   
        Printf                                 
        Jump         -printArray-5-start       
        Label        -printArray-5-exit        
