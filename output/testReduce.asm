        ...
        Exchange                               
        StoreI                                 
        Label        -reduceOperator-7-loopStart 
        Duplicate                              
        PushD        $a-indexing-index         
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        JumpFalse    -reduceOperator-7-dontAddToArray 
        Label        -reduceOperator-7-addToArray 
        PushD        $a-data-temp              
        LoadI                                  
        StoreI                                 
        PushI        1                         
        ...
        Exchange                               
        StoreI                                 
        Jump         -reduceOperator-7-goToNextElememt 
        Label        -reduceOperator-7-dontAddToArray 
        Pop                                    
        Label        -reduceOperator-7-goToNextElememt 
        PushD        $a-array-length-temp      
        LoadI                                  
        PushI        1                         
        Subtract                               
        ...
        Exchange                               
        StoreI                                 
        JumpPos      -reduceOperator-7-loopStart 
        Pop                                    
        PushD        $a-array-index-temp       
        LoadI                                  
        PushD        $record-creation-temp     
        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -loadArray-9-exit         
        Jump         -loadArray-9-loop         
        Label        -loadArray-9-exit         
        PushD        $a-array-length-temp      
        LoadI                                  
        ...
        PushD        $print-format-character   
        Printf                                 
        Jump         -printArray-10-start      
        Label        -printArray-10-exit       
