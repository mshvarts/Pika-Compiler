        ...
        StoreI                                 
        Label        -declaration-7-exit       
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% isOdd
        PushPC                                 
        Jump         -function-8-end           
        Label        -function-8-start         
        PushD        $stack-pointer            
        LoadI                                  
        PushI        -4                        
        Add                                    
        ...
        Jump         -function-8-exit          
        Label        -function-8-exit          
        PushD        $frame-pointer            
        LoadI                                  
        PushI        -8                        
        Add                                    
        ...
        StoreC                                 
        Return                                 
        Label        -function-8-end           
        StoreI                                 
        Label        -declaration-10-exit      
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% parities
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -mapOperator-11-loopStart 
        Duplicate                              
        PushD        $a-indexing-index         
        LoadI                                  
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        JumpPos      -mapOperator-11-loopStart 
        Pop                                    
        PushD        $a-array-length-temp      
        LoadI                                  
        PushD        $record-creation-temp     
        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -loadArray-13-exit        
        Jump         -loadArray-13-loop        
        Label        -loadArray-13-exit        
        PushD        $a-array-length-temp      
        LoadI                                  
        ...
        PushD        $print-format-character   
        Printf                                 
        Jump         -printArray-14-start      
        Label        -printArray-14-exit       
