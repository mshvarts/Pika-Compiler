        ...
        PushD        $a-string-length-temp     
        LoadI                                  
        JumpPos      -string-indexing-2-valid-slice 
        Jump         $a-empty-string-slice     
        Label        -string-indexing-2-valid-slice 
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        12                        
        Add                                    
        ...
        PushD        $a-string-length-temp     
        LoadI                                  
        JumpPos      -string-indexing-4-valid-slice 
        Jump         $a-empty-string-slice     
        Label        -string-indexing-4-valid-slice 
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        12                        
        Add                                    
        ...
        PushD        $a-string-length-temp     
        LoadI                                  
        JumpPos      -string-indexing-6-valid-slice 
        Jump         $a-empty-string-slice     
        Label        -string-indexing-6-valid-slice 
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        12                        
        Add                                    
