        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -populate-5-exit          
        Jump         -populate-5-start         
        Label        -populate-5-exit          
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        $a-addr-temp              
        Exchange                               
        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -populate-8-exit          
        Jump         -populate-8-start         
        Label        -populate-8-exit          
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        $a-addr-temp              
        Exchange                               
        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -populate-11-exit         
        Jump         -populate-11-start        
        Label        -populate-11-exit         
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        $a-addr-temp              
        Exchange                               
        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -populate-14-exit         
        Jump         -populate-14-start        
        Label        -populate-14-exit         
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -populate-19-exit         
        Jump         -populate-19-start        
        Label        -populate-19-exit         
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        $a-addr-temp              
        Exchange                               
        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -populate-23-exit         
        Jump         -populate-23-start        
        Label        -populate-23-exit         
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        3                         
        Duplicate                              
        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -loadArray-30-exit        
        Jump         -loadArray-30-loop        
        Label        -loadArray-30-exit        
        PushD        $a-array-length-temp      
        LoadI                                  
        PushD        $array-opening-char       
        LoadC                                  
        ...
        PushD        $print-format-character   
        Printf                                 
        Jump         -printArray-31-start      
        Label        -printArray-31-exit       
        PushD        $array-closing-char       
        LoadC                                  
        PushD        $print-format-character   
        Printf                                 
        ...
        PushD        $print-format-space       
        Printf                                 
        Jump         -for-33-continue          
        Label        -for-33-continue          
        PushD        $a-length-temp            
        LoadI                                  
        PushI        1                         
        Subtract                               
