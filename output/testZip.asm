        ...
        DataC        100                       
        DataC        0                         
        DLabel       $print-frac-format-rational-neg 
        DataC        45                        %% "-_%d/%d"
        DataC        95                        
        DataC        37                        
        DataC        100                       
        ...
        DataC        100                       
        DataC        0                         
        DLabel       $print-whole-format-rational-neg 
        DataC        45                        %% "-%d"
        DataC        37                        
        DataC        100                       
        DataC        0                         
        DLabel       $print-whole-frac-format-rational-neg 
        DataC        45                        %% "-%d_%d/%d"
        DataC        37                        
        DataC        100                       
        DataC        95                        
        ...
        Jump         $$general-runtime-error   
        DLabel       $errors-zero-length       
        DataC        65                        %% "Array length is zero"
        DataC        114                       
        DataC        114                       
        DataC        97                        
        DataC        121                       
        ...
        DataC        0                         
        Label        $a-zero-length            
        PushD        $errors-zero-length       
        Jump         $$general-runtime-error   
        DLabel       $errors-different-array-lengths 
        DataC        97                        %% "array lengths must be the same"
        DataC        114                       
        DataC        114                       
        DataC        97                        
        DataC        121                       
        ...
        DataC        101                       
        DataC        0                         
        Label        $a-different-lengths      
        PushD        $errors-different-array-lengths 
        Jump         $$general-runtime-error   
        ...
        DataZ        4                         
        DLabel       $a-indexing-array-2       
        DataZ        4                         
        DLabel       $a-indexing-index         
        DataZ        4                         
        DLabel       $s-indexing-array         
        DataZ        4                         
        DLabel       $s-indexing-index         
        DataZ        4                         
        DLabel       $s-indexing-index-2       
        DataZ        4                         
        ...
        PushD        $a-array-index-temp       
        LoadI                                  
        JumpNeg      -populate-2-exit          
        Jump         -populate-2-start         
        Label        -populate-2-exit          
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        ConvertI                               
        Call         $lowest-terms             
        Jump         -function-4-exit          
        Label        -function-4-exit          
        ...
        PushI        8                         
        Add                                    %% ratIt
        PushD        $lambda-ref-temp          
        Exchange                               
        StoreI                                 
        PushD        $a-indexing-array-2       
        Exchange                               
        StoreI                                 
        ...
        Exchange                               
        StoreI                                 
        JumpPos      -zipOperator-5-loopStart  
        PushD        $a-array-length-temp      
        LoadI                                  
        PushD        $record-creation-temp     
        LoadI                                  
        ...
        LoadI                                  
        Divide                                 
        JumpTrue     -rational-8-integerNotZeroLabel 
        PushD        $r-rational-denominator-temp 
        LoadI                                  
        PushD        $r-rational-numerator-temp 
        LoadI                                  
        ...
        LoadI                                  
        Multiply                               
        JumpNeg      -rational-8-fracNegPrint  
        PushD        $print-frac-format-rational 
        Jump         -rational-8-exitPrint     
        Label        -rational-8-fracNegPrint  
        Duplicate                              
        PushI        -2147483648               
        BTXor                                  
        JumpNeg      -macros-9-negative        
        Negate                                 
        Label        -macros-9-negative        
        Exchange                               
        Duplicate                              
        PushI        -2147483648               
        BTXor                                  
        JumpNeg      -macros-10-negative       
        Negate                                 
        Label        -macros-10-negative       
        Exchange                               
        PushD        $print-frac-format-rational-neg 
        Jump         -rational-8-exitPrint     
        Label        -rational-8-integerNotZeroLabel 
        PushD        $r-rational-numerator-temp 
        LoadI                                  
        PushD        $r-rational-denominator-temp 
        LoadI                                  
        Remainder                              
        JumpFalse    -rational-8-fracIsZeroLabel 
        PushD        $r-rational-denominator-temp 
        LoadI                                  
        PushD        $r-rational-numerator-temp 
        LoadI                                  
        ...
        LoadI                                  
        Multiply                               
        JumpNeg      -rational-8-wholeNegPrint 
        PushD        $print-whole-frac-format-rational 
        Jump         -rational-8-exitPrint     
        Label        -rational-8-wholeNegPrint 
        PushD        $a-data-temp              
        Exchange                               
        StoreI                                 
        Duplicate                              
        PushI        -2147483648               
        BTXor                                  
        JumpNeg      -macros-11-negative       
        Negate                                 
        Label        -macros-11-negative       
        Exchange                               
        Duplicate                              
        PushI        -2147483648               
        BTXor                                  
        JumpNeg      -macros-12-negative       
        Negate                                 
        Label        -macros-12-negative       
        Exchange                               
        PushD        $a-data-temp              
        LoadI                                  
        Duplicate                              
        PushI        -2147483648               
        BTXor                                  
        JumpNeg      -macros-13-negative       
        Negate                                 
        Label        -macros-13-negative       
        PushD        $print-whole-frac-format-rational-neg 
        Jump         -rational-8-exitPrint     
        Label        -rational-8-fracIsZeroLabel 
        PushD        $r-rational-numerator-temp 
        LoadI                                  
        PushD        $r-rational-denominator-temp 
        LoadI                                  
